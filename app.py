...
# ---------- UI ----------
st.title("🚆 Crew Night Duty System (Final Real Logic)")
...
if uploaded_file:
    try:
        ...
        # ---------- STREAK LOGIC (NO GAP + ONLY NIGHT) ----------
        final_rows = []
        ...
        if not final_df.empty:
            ...
            st.subheader("📊 Final Report (Strict Railway Logic)")
            ...
            st.warning("⚠️ No valid streak found")
